...
const head = () => {
    return (
        <Helmet>
            <title>Privacy Policy - Product List Genie</title>
        </Helmet>
    );
}
        ...
        <div className="grid">
            ...
            <div className="column column_12_12">
                <div className="content_wrap noBoarder">
                    ...
                    <div className="desc">
                        <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from ProductListGenie.com (the “Site”).</p>
                        ...
                        <p>Others: Adroll - http://optout.networkadvertising.org/?c=1#!/</p>
                        ...
                        <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at admin@productlistgenie.com or by mail using the details provided below:</p>
                        <p><strong>Product List Genie</strong></p>
                        <p>[Re: Privacy Compliance Officer]</p>
                        <p>7065 W Road 130 679, Las Vegas, NV, 89130, United States</p>
                    </div>
                </div>
            </div>
