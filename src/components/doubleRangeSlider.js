    ...
    componentDidMount(){
        ...
        var ZBRangeSlider = function (id) {
            ...
            function calculateValue() {
                ...
                // jerome end added
                slider.setAttribute('se-min-value', minValue.toFixed(1).replace(".0",""));
                slider.setAttribute('se-max-value', maxValue.toFixed(1).replace(".0",""));
            }
            // link events
        ...
        // -------------------
        // How to use? 
        var newRangeSlider = new ZBRangeSlider(that.props.id);
        newRangeSlider.onChange = function (min, max) {
            // console.log('onchange', 'Min: ' + min + ' Max: ' + max)
            if(that.props.onUpdate){
                that.props.onUpdate(min, max)
            }
        }
        newRangeSlider.didChanged = function (min, max) {
            // console.log('didchange', 'Min: ' + min + ' Max: ' + max)
            if(that.props.didChanged){
                that.props.didChanged(min, max)
            }
        }
        ...
        return (
            <div className="double-range-slider">
                <div className="content">
                    <div id={this.props.id} se-min={this.props.seMin} se-step={this.props.seStep} se-min-value={this.props.seMinVal} se-max-value={this.props.seMaxVal} se-max={this.props.seMax} className="slider">
                        <div className="slider-touch-left">
                            <span></span>
                        </div>
                        <div className="slider-touch-right">
                            <span></span>
                        </div>
