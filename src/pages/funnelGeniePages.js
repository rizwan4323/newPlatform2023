...
class FunnelGeniePages extends React.Component {
    constructor(props) {
        super();
        this.state = {
    ...
    head() {
        return (
            <Helmet bodyAttributes={{ class: "dashboardPage" }}>
                <title>Funnel Genie Pages - Product List Genie</title>
            </Helmet>
        );
    }
    toColor(str) {
...
export default withAuth(session => session && session.getCurrentUser)(FunnelGeniePages);