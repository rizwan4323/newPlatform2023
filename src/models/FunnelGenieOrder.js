...
const FunnelGenieOrderSchema = new Schema({
    ...
    plgbuttonID: { type: String, default: "" },
    has_pod: { type: Boolean, default: false },
    ...
    line_items: {
        ...
        cost_of_goods: { type: Number, default: 0}, // cost of goods chnged from Number to String
...
module.exports = mongoose.model('FunnelGenieOrder', FunnelGenieOrderSchema);