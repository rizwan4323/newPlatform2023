...
class HomepageTrial extends React.Component {
    constructor() {
        super();
        this.state = {
            data: [],
            ...
            // video
            h_trial_video: 'https://player.vimeo.com/video/308208468',
        }
    ...
    getHomepageVideo(){
        ...
        .then(res => res.json())
        .then(result => {
            if(result.data.getAdminHomepageVideo.homepage_video_trial){
                this.setState({
    ...
    addNewTimer(){
        if (this.props.session.getCurrentUser) {
            ...
            if (this.props.session.getCurrentUser.privilege <= 5 || !this.props.session.getCurrentUser.success_rebill || !this.props.session.getCurrentUser.kartra_tags.includes('PLG Loyalty Program')) { // User Privilege
                ...
                if (durationV2.days >= 0 && durationV2.hours >= 0 && durationV2.minutes >= 0 && duration.seconds() >= 0) {
                    this.setState({
                        rebillTimer: true
                    }, () => {
                ...
                <div className="grid clear">
                    <div className="column column_6_12 text-center">
                        <div className="column column_12_12">
                            <iframe src={this.state.h_trial_video} width="600" height="360" frameBorder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowFullScreen></iframe>
                        </div>
                        <div className="column column_12_12">
...
export default withAuth(session => session && session.getCurrentUser)(HomepageTrial);